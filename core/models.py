...
class Product(models.Model):
     ...
     user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True)
     category = models.ForeignKey(Category, on_delete=models.SET_NULL, null=True, related_name="category") # type: ignore
...
class ProductImages(models.Model):
        ...
        product = models.ForeignKey(Product, related_name="p_images", on_delete=models.SET_NULL, null=True) # type: ignore
        date = models.DateTimeField(auto_now_add=True)
